...
(() => {
    ...
    if (t) {
        ...
        console.log(JSON.parse(localStorage['BotPenguin-649948658b241160b89c8560']).configuration.generalSettings.whiteLabel)
        JSON.parse(localStorage['BotPenguin-649948658b241160b89c8560']).configuration.generalSettings.whiteLabel = true
        console.log(JSON.parse(localStorage['BotPenguin-649948658b241160b89c8560']).configuration.generalSettings.whiteLabel)
    } else {
