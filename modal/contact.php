...
$php_main_email = "vishesh@innovativeglove.com; avi@innovativeglove.com";
...
$php_template = '<div style="padding:50px;">Hello ' . $php_name . ',<br/>'
	...
	. '<strong style="color:#00ff00;">Name:</strong>  ' . $php_name . '<br/>'
	. '<strong style="color:#00ff00;">Email:</strong>  ' . $php_email . '<br/>'
	. '<strong style="color:#00ff00;">Subject:</strong>  ' . $php_subject1 . '<br/><br/>'
	. '<strong style="color:#00ff00;">Message:</strong>  ' . $php_message . '<br/><br/>'
	. 'This is to confirm to you that we have recevied your contact information and details.'
	. '<br/>'
